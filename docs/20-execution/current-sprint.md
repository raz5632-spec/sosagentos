...
| ANA-001 KPI snapshots + CEO dashboard | next | kpi_snapshots writer + GET /orgs/:orgId/dashboard (students at risk, pending approvals, invocation costs, content pipeline) |
